        ...
        <div className="flex flex-col items-center p-2 border-b border-slate-700/50">
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="w-8 h-8 bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg flex items-center justify-center mb-2 cursor-pointer hover:bg-[#3a3a3a] transition-colors">
