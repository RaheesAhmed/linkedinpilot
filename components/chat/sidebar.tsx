    ...
    <div className={`flex flex-col h-full bg-[#1a1a1a] border-r border-[#2a2a2a] ${className}`}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-[#2a2a2a]">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg flex items-center justify-center hover:bg-[#3a3a3a] transition-colors">
            <span className="text-lg">🚁</span>
          </div>
          <h2 className="text-white font-semibold text-lg">LinkedIn Pilot</h2>
        </div>
